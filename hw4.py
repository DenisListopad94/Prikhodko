...
if d % 2 == 0 and e % 2 == 0 and f % 2 == 0:
    print(3)
elif d % 2 == 0 and e % 2 == 0:
    print(2)
elif e % 2 == 0 and f % 2 == 0:
    print(2)
elif d % 2 == 0 and f % 2 == 0:
    print(2)
elif d % 2 == 0 or e % 2 == 0 or f % 2 == 0:
    print(1)
else:
    print("No any even numbers")
print("_______________")
# Решила очень некрасиво, как по-другому - не придумала :(
...
if cows % 10 == 1 and cows != 11:
    print("На лугу ", cows, " корова")
elif 2 <= cows % 10 <= 4 and cows // 10 != 1:
    print("На лугу ", cows, " коровы")
else:
    print("На лугу ", cows, " коров")
print("_______________")
